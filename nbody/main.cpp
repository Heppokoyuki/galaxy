...
main(int argc, char *argv[])
{
    ...
    for(int i = 0; i < N; i += 4) {
        ...
        for(int j = 0; j < N; j += 2) {
            ...
            MJ = _mm256_shuffle_ps(XJ, XJ, 0b00000000);
            YJ = _mm256_shuffle_ps(XJ, XJ, 0b10101010);
            ZJ = _mm256_shuffle_ps(XJ, XJ, 0b01010101);
            XJ = _mm256_shuffle_ps(XJ, XJ, 0b11111111);
